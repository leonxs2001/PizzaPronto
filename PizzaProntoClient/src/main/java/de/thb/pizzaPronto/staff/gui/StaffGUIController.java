package de.thb.pizzaPronto.staff.gui;

// import de.thb.dim.pizzaPronto.valueObjects.ChefVO;
import de.thb.pizzaPronto.generalGui.MainView;
import de.thb.pizzaPronto.staff.rest.ChefVO;
import de.thb.pizzaPronto.staff.rest.DeliveryManVO;
...
public class StaffGUIController {
	...
	public StaffGUIController(MainView view) {
		...
		StaffPanel staffPanel = view.getMainPanel().getLayoutPanel().getStaffPanel2();
