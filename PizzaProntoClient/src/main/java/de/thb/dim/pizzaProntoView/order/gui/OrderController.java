package de.thb.dim.pizzaProntoView.order.gui;
...
import de.thb.pizzaPronto.businessObjects.io.OrderSerializer;
...
import de.thb.dim.pizzaProntoView.customer.gui.CustomerPanel;
...
import de.thb.dim.pizzaProntoView.menu.gui.MenuPanel;
...
public class OrderController {
	...
	public OrderController(MainView view) {
		...
		customerPanel = view.getMainPanel().getLayoutPanel().getCustomerPanel();
		menuPanel = view.getMainPanel().getLayoutPanel().getMenuPanel();
...
//		orderMenuTableModel = (DefaultTableModel) orderMenuTable.getModel();
		...
		JComboBox<Integer> comboBox = view.getMainPanel().getLayoutPanel().getOrderPanel().getCustomerComboBox();
